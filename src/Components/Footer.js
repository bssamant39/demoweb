        ...
        <footer className="zerogrid">
            <div className="wrap-footer">
                <div className="row">
                    ...
                    <div className="col-1-3">
                        <div className="wrap-col">
                            <h4>Location</h4>
                            <div className="wrap-map"><iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3164.289259162295!2d-120.7989351!3d37.5246781!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x8091042b3386acd7%3A0x3b4a4cedc60363dd!2sMain+St%2C+Denair%2C+CA+95316%2C+Hoa+K%E1%BB%B3!5e0!3m2!1svi!2s!4v1434016649434" style={{ width: "100%", height: "200", frameborder: "0", border: "0" }}></iframe></div>
                        </div>
                    </div>
                    <div className="col-1-3">
                        <div className="wrap-col">
            ...
            <div className="copyright">
                <div className="wrapper">
                    <ul className="quick-link f-right">
